...
mafft --keeplength --thread 8 --add $path/GCF_000017605.1_ASM1760v1_genomic.fna $path/roary_host/core_gene_alignment.aln > $path/core_genes_aln_outgroup_Lbiflexa.aln
